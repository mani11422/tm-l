...
import { EmployerSignupModal } from './EmployerSignupModal.jsx';
...
export function LoginForm() {
  ...
  const handleDemoLogin = (role) => {
    if (role === 'admin') {
      setEmail('admin@taskmaster.com');
      setPassword('password123');
    } else {
      setEmail('employee@taskmaster.com');
      setPassword('password123');
    }
  };

  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900">
      <motion.div
      ...
      <button
        className="mt-6 px-6 py-2 rounded bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold shadow-lg hover:from-purple-600 hover:to-blue-600 transition"

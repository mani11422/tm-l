...
export function DailyLog() {
  ...
  const userTimeEntries = useMemo(() => {
    ...
    if (user.role === 'Team Lead') {
      // This would need team data to be more robust. For now, show own and Member Mary's.
  ...
  const groupedEntries = useMemo(() => {
    return userTimeEntries.reduce((acc, entry) => {
  ...
  const getTaskName = (taskId) => tasks.find(t => t.id === taskId)?.title || 'Unknown Task';

...
import { LayoutDashboard, FolderKanban, ListTodo, Users, Calendar, BarChart3, Settings, ChevronsLeft, ChevronsRight, LogOut, Building, Clock, Briefcase } from 'lucide-react';
...
const NavItem = ({ item, activeView, onViewChange, isCollapsed }) => (
  <Button
...
export function Sidebar({ activeView, onViewChange, isCollapsed, onToggleCollapse }) {

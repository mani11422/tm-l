...
import { BarChart3, Clock, Users, Zap, FileDown, CircleDotDashed as LucideIcon } from 'lucide-react';
...
const doughnutOptions: ChartOptions<'doughnut'> = { ...chartOptions, scales: {} };
...
const InfoCard = ({ title, value, icon: Icon, change }: InfoCardProps) => (

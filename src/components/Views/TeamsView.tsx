...
import { TeamCard } from '@/components/Views/TeamCard.tsx';
import { CreateTeamModal } from '@/components/Modals/CreateTeamModal.tsx';
...
export function TeamsView({ teams, createTeam }: TeamsViewProps) {
